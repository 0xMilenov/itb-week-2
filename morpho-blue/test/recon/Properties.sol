...
abstract contract Properties is BeforeAfter, Asserts {
  ...
  // for dynamic markets here the shared loanToken breaks this property
  // because we can have two markets with equal loanToken
  ...
  // for dynamic markets here the shared collateralToken breaks this property
  // because we can have two markets with equal collateral
